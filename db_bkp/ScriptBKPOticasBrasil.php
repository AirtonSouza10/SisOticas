...
backup_tables("localhost","root","","sisotica");//don't forget to fill with your own database access informations
...
function backup_tables($host,$user,$pass,$name)
{
    ...
    echo "<script>";
    echo "window.location.href = '../view/index2.php';"; //redireciona para pagina principal
    echo "</script> ";
}
?>