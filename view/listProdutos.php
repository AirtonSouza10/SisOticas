            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        ...
                        <li>
                            <a href="listprodutos.php">Técnicos</a>
                        </li>
                        <li>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="cadastraProdutos.php"><i class='fas fa-plus'></i></a>
                            </li>
                            </li>
                        </ul>
                    </div>
            ...
            ?>
                ...
                <?php
                 foreach ($produtos as $p) {
                      ...
                      echo "  <td>{$p['tipo']}</td>";
                      echo "  <td>{$p['cor']}</td>";                      
                      echo "  <td>{$p['Stattus']}</td>";
                      echo "  <td class='actions'>";
                      echo "  <a href='../DomPdf/viewProdutos.php?id={$p["idproduto"]}'><i class='fas fa-eye'></i></a>";
                      echo "  <a href='../controller/deletaProduto.php?id={$p["idproduto"]}'><i class='fas fa-trash-alt'></i></a>"; 
                      echo "  <a href='alteraProduto.php?id={$p["idproduto"]}'><i class='fas fa-edit'></i></a>";                      
