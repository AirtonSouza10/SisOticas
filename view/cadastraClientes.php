    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!--Formulário de cadastro de Clientes-->
                <form method="POST" action="../controller/processaCadastraClientes.php">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" class="form-control" id="inputRg" placeholder="RG" name="rg"pattern="[0-9\s]+$" title="Digite apenas números nesse campo">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="tel" class="form-control" id="inputTelefone" placeholder="DDNNNNNNNNN" name="telefone"pattern="[0-9\s]+$" title="Digite só numeros nesse campo">
                    </div>                    
                    <div class="form-group col-md-3">
                        <label for="inputCelular">Telefone Celular</label>
                        <input type="tel" class="form-control" id="inputCelular" placeholder="DDNNNNNNNNN" name="celular" pattern="[0-9\s]+$" title="Digite só numeros nesse campo" minlength="10" maxlength="11">
                    </div> 
