...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Alteração de Técnico</h2>
            <h4>Preencha os campos abaixo:</h4>
            <!--Formulário de cadastro de tecnico-->
                <form method="POST" action="../controller/alteraTecnicos.php">
                  <div class="form-row">
                    <div class="form-group">
                       <input type="hidden" class="form-control" id="idtecnico" name="idtecnico" value="<?php echo $tecnico['idTecnico']?>">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputNome">Nome</label>
                      <input type="text" class="form-control" id="inputNome" placeholder="Nome" name="nome" required="required" pattern="^[a-zA-Z][a-zA-Z- \.]{3,45}$" title="Digite apenas letras nesse campo" minlength="10" maxlength="45" value="<?php echo $tecnico['Nome']?>" >
                    </div>
                    <div class="form-group col-md-2">
                      <label for="inputCpf">CPF</label>
                      <input type="text" class="form-control" id="Cpf" placeholder="CPF" name="cpf" required="required" pattern="[0-9\s]+$" title="Digite apenas numeros nesse campo" minlength="11" maxlength="11" value="<?php echo $tecnico['CPF']?>">
                    </div>
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-group form-control" name="empresa" >
                            ...
                            <?php                         
                              foreach ($empresa as $e) {
                                echo "<option selected value='{$e["idempresa"]}'>{$e["razao"]} {$e["cnpj"]} </option>";
                              }
                            ?>
                        </select>
                    </div>                      
