...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="cadastraTecnicos.php"><i class='fas fa-plus'></i></a></a>
                            </li>
                            </li>
                        </ul>
                    </div>
            ...
            $tecnicos = $tecnicoDAO->getAllTecnicos();
            ?>
                  <!--Clientes-->
                ...
                <?php
                 foreach ($tecnicos as $t) {
                      echo "<tr>";
                      echo "  <td>{$t['idTecnico']}</td>";
                      echo "  <td>{$t['Nome']}</td>";
                      echo "  <td>{$t['CPF']}</td>";
                      echo "  <td>{$t['Perfil']}</td>";
                      echo "  <td>{$t['Stattus']}</td>";                      
                      echo "  <td>{$t['Razao']}</td>";
                      echo "  <td class='actions'>";
                      echo "  <a href='../DomPdf/viewTecnicos.php?id={$t["idTecnico"]}'><i class='fas fa-eye'></i></a>";
                      echo "  <a href='../controller/deletaTecnico.php?id={$t["idTecnico"]}'><i class='fas fa-trash-alt'></i></a>"; 
                      echo "  <a href='alteraTecnico.php?id={$t["idTecnico"]}'><i class='fas fa-edit'></i></a>";                      
