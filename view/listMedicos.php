                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="cadastraMedicos.php"><i class='fas fa-plus'></i></a>
                            </li>
                            </li>
                        </ul>
                    </div>
            ...
            ?>
                ...
                <?php
                 foreach ($medicos as $m) {
                      echo "<tr>";
                      echo "  <td>{$m['idmedico']}</td>";
                      echo "  <td>{$m['nome']}</td>";
                      echo "  <td>{$m['crm']}</td>";
                      echo "  <td>{$m['clinica']}</td>";
                      echo "  <td class='actions'>";
                      echo "  <a href='../DomPdf/viewMedicos.php?id={$m["idmedico"]}'><i class='fas fa-eye'></i></a>";
                      echo "  <a href='../controller/deletaMedico.php?id={$m["idmedico"]}'><i class='fas fa-trash-alt'></i></a>"; 
                      echo "  <a href='alteraMedico.php?id={$m["idmedico"]}'><i class='fas fa-edit'></i></a>";                      
