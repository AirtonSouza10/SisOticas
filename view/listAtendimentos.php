...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="cadastraAtendimentos.php"><i class='fas fa-plus'></i></a></a>
                            </li>
                            </li>
                        </ul>
                    </div>
            ...
            $atendimentos = $atendimentoDAO->getAllAtendimentos();
            ?>
                  <!--Clientes-->
                ...
                <?php
                 foreach ($atendimentos as $a) {
                      echo "<tr>";
                      echo "  <td>{$a['idatendimento']}</td>";
                      echo "  <td>{$a['cliente']}</td>";
                      echo "  <td>{$a['dataatendimento']}</td>";
                      echo "  <td>{$a['dataentrega']}</td>";
                      echo "  <td>{$a['descricao']}</td>";
                      echo "  <td>{$a['cor']}</td>";
                      echo "  <td>{$a['status_2']}</td>";                      
                      echo "  <td class='actions'>";
                      echo "  <a href='../DomPdf/viewAtendimentos.php?id={$a["idatendimento"]}'><i class='fas fa-eye'></i></a>";
                      echo "  <a href='../controller/cancelaAtendimento.php?id={$a["idatendimento"]}'><i class='fas fa-trash-alt'></i></a>"; 
                      echo "  <a href='alteraAtendimento.php?id={$a["idatendimento"]}'><i class='fas fa-edit'></i></a>";                      
