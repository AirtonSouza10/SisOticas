...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="cadastraClientes.php"><i class='fas fa-plus'></i></a></a>
                            </li>
                            </li>
                        </ul>
                    </div>
            ...
            $nivers = $clienteDAO->getAllClientes();
            ?>
                  <!--Clientes-->
                ...
                <?php
                 foreach ($nivers as $n) {
                      ...
                      echo "  <td>{$n['Bairro']}</td>";
                      echo "  <td>{$n['UF']}</td>";                      
                      echo "  <td>{$n['Celular']}</td>";
                      echo "  <td>{$n['email']}</td>";
                      echo "  <td class='actions'>";
                      echo "  <a href='../DomPdf/viewClientes.php?id={$n["idcliente"]}'><i class='fas fa-eye'></i></a>";
                      echo "  <a href='../controller/deletaCliente.php?id={$n["idcliente"]}'><i class='fas fa-trash-alt'></i></a>"; 
                      echo "  <a href='alteraCliente.php?id={$n["idcliente"]}'><i class='fas fa-edit'></i></a>";                      
