    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!--Formulário de cadastro de medicos-->
                <form method="POST" action="../controller/processaCadastraMedicos.php">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" id="Crm" placeholder="CRM" name="crm" required="required" pattern="[0-9\s]+$" title="Digite apenas numeros nesse campo" minlength="2" maxlength="45">
                    </div>
