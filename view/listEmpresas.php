...
<body>
    ...
    <div class="wrapper">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        ...
                        <li>
                            <a href="listempresas.php">Técnicos</a>
                        </li>
                        <li>
        ...
        <div id="content">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="cadastraEmpresas.php"><i class='fas fa-plus'></i></a></a>
                            </li>
                            </li>
                        </ul>
                    </div>
            ...
            <h2>Empresas</h2>
            <!--importacao page empresaDAO-->
            <?php
            require_once '../dao/empresaDAO.php';


            $empresaDAO = new EmpresaDAO();
            $empresas = $empresaDAO->getAllEmpresas();
            ?>
                  <!--empresas-->
                ...
                <?php
                 foreach ($empresas as $e) {
                      ...
                      echo "  <td>{$e['razao']}</td>";
                      echo "  <td>{$e['cnpj']}</td>";
                      echo "  <td>{$e['inscricao']}</td>";
                      echo "  <td class='actions'>";
                      echo "  <a href='../DomPdf/viewEmpresas.php?id={$e["idempresa"]}'><i class='fas fa-eye'></i></a>";
                      echo "  <a href='../controller/deletaEmpresa.php?id={$e["idempresa"]}'><i class='fas fa-trash-alt'></i></a>"; 
                      echo "  <a href='alteraEmpresa.php?id={$e["idempresa"]}'><i class='fas fa-edit'></i></a>";                      
